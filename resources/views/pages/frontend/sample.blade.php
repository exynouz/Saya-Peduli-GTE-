...
@endguest
@auth
<title>Beranda | Saya Peduli</title>
@endauth
@endsection
...
<section id="up"
    ...
    <h1 id="up" class="text-5xl font-bold md:text-7xl xl:text-7xl">Saya<span class="text-vermillion">Peduli</span></h1>
    <p class="text-xs font-medium leading-5 text-center md:px-20 lg:px-32 text-davys-grey md:text-base lg:text-sm md:leading-8 lg:leading-7">
        Kami percaya bahwa setiap suara, baik dari karyawan maupun masyarakat, memiliki nilai penting dalam menciptakan lingkungan kerja dan layanan yang lebih baik. Bergabunglah dalam sistem pengaduan ini  untuk memastikan perbaikan yang berkelanjutan dan transparansi dalam setiap langkah.
        Mari bersama-sama mewujudkan perubahan positif.</p>
