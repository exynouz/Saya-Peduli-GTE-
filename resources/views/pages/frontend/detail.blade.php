...
<section style="background-color:#3A5A40 !important;"
    ...
    <h1 class="text-3xl font-bold leading-10 text-center detail-title md:text-5xl xl:text-6xl md:leading-normal text-white">
    {{ $complaint->title }}</h1>

    <h6
        class="px-3 py-1 text-xs font-medium border rounded-sm text-davys-grey border-davys-grey md:text-base lg:text-lg text-white">
        {{ $complaint->category->category }}
    </h6>
    <p class="text-xs font-bold md:text-base lg:text-lg text-white">{{ $complaint->created_at->format('H:i, d-m-Y')
        }}</p>
    ...
    <img class="absolute w-1/4 md:w-44 xl:w-[10rem] right-[-8%] md:-right-12 bottom-[7%] -z-10"
        ...
        <div class="waves-mobile w-full absolute bottom-0 left-0">
    <svg class="hero-waves w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
<section class="px-6 pt-16 pb-10 bg-white md:px-10 lg:px-24 2xl:px-48 md:pt-28 md:pb-16 lg:pt-36 lg:pb-20">
    <h2 class="text-2xl font-bold text-center md:text-4xl text-blues">Detail Informasi</h2>
    <div
        class="xl:flex xl:gap-5 py-8 md:py-12 xl:py-20 px-5 md:px-10 xl:px-14 mt-5 md:mt-11 xl:mt-20 rounded-md border-2 border-blue-500  xl:shadow-[10px_10px_0px_#008bf8]">
        <div class="xl:w-80">
...
<section class="px-6 py-10 bg-white md:px-10 lg:px-24 2xl:px-48 md:py-16 lg:py-20 ">
    <h2 class="text-2xl font-bold text-center md:text-4xl text-blues">Isi Pengaduan</h2>
    <div class="flex flex-col items-center gap-2 px-3 mt-5 rounded-md md:gap-3 lg:gap-5 md:px-4 lg:px-6 xl:px-14 py-7 md:py-10 lg:py-16 xl:py-20 md:mt-11 xl:mt-20 bg-white border-2 border-blue-500 ">
...
<section class="px-6 py-10 bg-white md:px-10 lg:px-24 2xl:px-48 md:py-16 lg:py-20">
    <h2 class="text-2xl font-bold text-center md:text-4xl text-blues">Pesan Tanggapan</h2>
    <div
    class="flex flex-col items-center gap-2 px-3 mt-5 rounded-md md:gap-3 lg:gap-5 md:px-4 lg:px-6 xl:px-14 py-7 md:py-10 lg:py-16 xl:py-20 md:mt-11 xl:mt-20 bg-white border-2 border-blue-500 ">
    ...
    <div class="flex justify-center mt-5 md:mt-11 xl:mt-20">
        <a href="{{ route('complainant.complaints.generate-pdf-detail', $complaint->id) }}"
            class="px-4 py-2 text-sm text-white bg-hejo border-2 border-hejo rounded-md md:px-9 md:py-3 md:text-xl lg:text-lg active:border-blues active:bg-blues active:shadow-xl lg:hover:bg-blues lg:hover:border-blues lg:hover:shadow-xl lg:transition-all lg:duration-500 lg:hover:transition-all lg:hover:duration-500">Cetak
            ke PDF</a>
    </div>
    @endauth
</section>
